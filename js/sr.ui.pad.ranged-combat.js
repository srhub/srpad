function RangedCombat (paper, rules, weaponTypes) {
	...
	this.draw = function() {
		...
		var attacker = new Avatar (paper, {x: 20, y: 60, name: "Aquila", path: "images/avatars/default.png"}).draw();

		// target avatar
		paper.text(605, 50, "TARGET").attr(avatarTextAttribute);
		var target = new Avatar (paper, {x: 605, y: 60, name: "NPC", path: "images/avatars/default.png"}).draw();
