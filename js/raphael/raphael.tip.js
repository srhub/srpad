/**
 * Draws a tip for a slider pointing to the given x , y coordinate
 * 
 * @param {Number} x
 ...
 * 		width of the triangle which points to the x,y coordinate, defaults to 5
 * @param {Number} triangleHeight 
 * 	 	height of the triangle which points to the x,y coordinate, defaults to 5
 */
Raphael.fn.tip = function(x, y, boxWidth, boxHeight, triangleWidth, triangleHeight) {
